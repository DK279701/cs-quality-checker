...
if api_key and uploaded_file:
    try:
        # Wczytanie pliku CSV z określonymi ustawieniami
        data = pd.read_csv(uploaded_file, sep=None, encoding='utf-8', engine='python')

        # Jeśli plik ma inne separator (np. średnik), zmień `sep` na ';'
        # data = pd.read_csv(uploaded_file, sep=';', encoding='utf-8', engine='python')
